...
export default function Hero() {
    return (
        <section className="relative overflow-hidden">
            ...
            {/* Indigo soft glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[560px] bg-[radial-gradient(ellipse_at_center,rgba(79,70,229,0.06)_0%,transparent_70%)] pointer-events-none" />

            <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 text-indigo-600 text-sm px-3.5 py-1.5 rounded-full mb-8">
                    <span className="size-1.5 bg-indigo-500 rounded-full" />
                ...
                <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-slate-900">
                    Schedule smarter.
                    <br />
                    <span className="text-indigo-500 italic">Grow faster.</span>
                </h1>
                ...
                <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
                    <Link to="/login" className="bg-indigo-500 text-white rounded-full font-medium hover:bg-indigo-600 hover:shadow-[0_8px_24px_rgba(79,70,229,0.35)] inline-flex items-center gap-2 text-[15px] px-8 py-3.5 w-full sm:w-auto justify-center transition-all">
            ...
            <div className="relative max-w-5xl mx-auto px-5 sm:px-8 pb-0">
                <div className="rounded-t-2xl overflow-hidden border border-gray-200 border-b-0">
                    {/* Browser chrome */}
                    <div className="flex items-center gap-2 px-4 py-3" style={{ background: "#eef2f6", borderBottom: "1px solid rgba(0,0,0,0.05)" }}>
                    ...
                    {/* Mock content */}
                    <div className="p-6" style={{ background: "#f5f7fa" }}>
                        {/* Stat row */}
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                            {[
                                ...
                                <div key={s.label} className="rounded-xl p-4 bg-white" style={{ border: "1px solid rgba(0,0,0,0.05)" }}>
                        ...
                        {/* Activity list */}
                        <div className="rounded-xl p-4 space-y-3 bg-white" style={{ border: "1px solid rgba(0,0,0,0.05)" }}>
