        ...
        <section id="pricing" className="py-24 bg-gray-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    <div className="mb-6 inline-flex items-center gap-1.5 bg-indigo-500/10 border border-indigo-500/15 text-indigo-600 text-[11px] font-medium tracking-[0.06em] uppercase px-3.5 py-1.5 rounded-full">
                    ...
                    <h2 className="font-serif font-medium text-4xl sm:text-5xl leading-tight text-gray-900">
                        ...
                        <br />
                        <span className="text-indigo-500 italic">of growth</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                    {pricingPlans.map((plan) => (
                        <div key={plan.name} className={`rounded-2xl border p-7 flex flex-col gap-6 relative ${plan.highlight ? "bg-indigo-500 text-white border-indigo-400 shadow-2xl shadow-indigo-100" : "bg-white text-slate-900 border-gray-200"}`}>
                            ...
                            <ul className="space-y-2.5">
                                {plan.features.map((f) => (
                                    <li key={f} className="flex items-center gap-2.5 text-sm">
                                        <div className={`size-4 rounded-full flex items-center justify-center shrink-0 ${plan.highlight ? "bg-indigo-400" : "bg-indigo-50"}`}>
                            ...
                            <Link to="/#" className={`mt-auto text-center font-semibold text-sm px-6 py-3 rounded-full ${plan.highlight ? "bg-white text-indigo-600 hover:bg-gray-50" : "bg-indigo-500 text-white hover:bg-indigo-600"}`}>
                                {plan.cta}
                            </Link>
                        </div>
                    ))}
