            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-serif text-4xl sm:text-5xl font-medium leading-tight text-gray-900">
                        ...
                        <br />
                        <span className="text-indigo-500 italic">social media workflow</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {features.map((f) => (
                        <div key={f.title} className="bg-gray-50 rounded-2xl border border-gray-100 p-6 hover:border-indigo-200 hover:shadow-md hover:shadow-indigo-50 group">
